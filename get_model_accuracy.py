...
parser.add_argument('-m', '--model_dir', help='model directory', default='./cnn-sdcca-sup/model/')
parser.add_argument('-o', '--output', help='output file', default='./results/cnn-sdcca-sup.mat')
